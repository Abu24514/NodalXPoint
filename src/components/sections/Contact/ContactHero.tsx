...
export default function ContactHero() {
  return (
    <section className="relative w-full overflow-hidden bg-canvas pb-4 pt-16 sm:pt-20">
      ...
      <div
        className="pointer-events-none absolute left-1/2 top-0 h-[320px] w-[320px] -translate-x-1/2 rounded-full opacity-[0.10] blur-[100px]"
      ...
      >
        ...
        <h1 className="font-display text-3xl font-semibold leading-[1.15] text-body sm:text-4xl md:text-5xl">
          Let&apos;s build something <span className="text-node">together.</span>
        </h1>

        <p className="mx-auto mt-5 max-w-xl text-sm leading-6 text-muted-ink sm:text-base sm:leading-7">
          Tell us what you&apos;re working on. We reply within one business day with next steps, not a sales script.
        </p>
      </motion.div>
    </section>
  );
