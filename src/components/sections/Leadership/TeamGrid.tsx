...
const TEAM = [
  {
    name: "Mohammad Asif",
    role: "Founder & CEO",
    bio: "Visionary founder leading nodalXpoint with a focus on innovation, business growth, and building scalable digital solutions.",
    photo: "https://res.cloudinary.com/ax3pwond/image/upload/v1785089544/Founder_kkn91m.jpg",
  },
  {
    name: "Yusuf Lesani",
    role: "Co-Founder",
    bio: "Drives company strategy and product execution while empowering teams to deliver impactful web and mobile experiences.",
    photo: "https://res.cloudinary.com/ax3pwond/image/upload/v1785089550/Co-founder_bhhewr.png",
  },
  {
    name: "Zohaib Tahir",
    role: "CTO",
    bio: "Leads technology architecture and engineering excellence, transforming ideas into reliable and scalable solutions.",
    photo: "https://res.cloudinary.com/ax3pwond/image/upload/v1785089731/Screenshot_2026-01-20_183845_akdzav.jpg",
  },
  {
    name: "Abhay Pratap",
    role: "Senior Developer",
    bio: "Builds high-performance applications with strong technical expertise, mentoring developers and delivering quality solutions.",
  ...
  },
  {
    name: "Arish Azmi",
    role: "Developer",
    bio: "Develops robust software solutions and APIs while contributing to innovative products and seamless user experiences.",
    photo: "https://res.cloudinary.com/ax3pwond/image/upload/v1785089768/1000062513-removebg-previe_en3lpk.jpg",
  },
  {
    name: "Md Warish",
    role: "Developer",
    bio: "Creates efficient digital solutions and provides reliable technical support to ensure smooth project delivery.",
